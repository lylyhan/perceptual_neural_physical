...
for init_id in range(n_inits):
    ...
    model_path = "efficientnet_spec_None_10_12_batch_size64_bn_var0.5_init-{}_LMA_0.0_constant_brake_1.00_damping_mean_outdim-5_log-True_minmax-True_lr-0.001".format(init_id)
