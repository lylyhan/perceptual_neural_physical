...
if __name__ == "__main__":
    ...
    if cnn_type == "cnn.wav2shape":
        ...
        model = cnn.EffNet(in_channels=1, outdim=outdim, loss="ploss", scaler=scaler, LMA=LMA, steps_per_epoch=steps_per_epoch, var=bn_var, save_path=pred_path, lr=lr, minmax=minmax, opt=opt)
