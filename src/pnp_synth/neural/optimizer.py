...
class Sophia(torch.optim.Optimizer):
    ...
    def hutchinson(self, p, grad):
        ...
        print("what's going, ", grad, p, u)
        new = u * grad #grad.dot(u)
        new.requires_grad = True
        #TODO: this doesn't work yet, u and grad does not require grad and has nothing to do with p, what's the deal
        hessian_vector_product = torch.autograd.grad(torch.dot(u, grad), p, retain_graph=True, allow_unused=True)[0]
